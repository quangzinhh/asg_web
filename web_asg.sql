...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 22, 2023 lúc 09:13 PM
...
--
-- Cấu trúc bảng cho bảng `services_info`
--
...
--
-- Đang đổ dữ liệu cho bảng `services_info`
--
...
--
-- Cấu trúc bảng cho bảng `services_place`
--

CREATE TABLE IF NOT EXISTS `services_place` (
...
--
-- Đang đổ dữ liệu cho bảng `services_place`
--
